...
:::info Access Level
These pages are for <RoleBadge role="Moderator" badgeIcon="moderator_role_icon.png" color="#e68027" /> and above. If you're a <RoleBadge role="Cutie Helper" badgeIcon="cutie_helper_role_icon.png" color="#38c8e8" />, check out the [Chat Moderation Overview](/docs/server-staff-handbook/chat-moderation) for your responsibilities.
:::

## Key Moderator Responsibilities

<CardGrid columns={2}>
  <Card title="Staff-Talk Tickets" status="info" icon="🎫" href="/docs/server-staff-handbook/moderator/staff-talk-tickets">
    <p>Handle member communication tickets, issue warnings, and manage punishment discussions.</p>
    <p><Link to="/docs/server-staff-handbook/moderator/staff-talk-tickets">Learn More →</Link></p>
  </Card>
...
<CardGrid columns={2}>
  <Card title="Closing Out Verifications" status="success" icon="✅" href="/docs/server-staff-handbook/moderator/closing-out-verifications">
...
- **[Ban Votes for Members](/docs/server-staff-handbook/ban-votes/ban-votes-for-members)** - Initiate and manage ban votes
- **[Chat Moderation](/docs/server-staff-handbook/chat-moderation/moderator-chat-moderation)** - De-escalation and formal moderation procedures
- **[Server Channels](/docs/server-staff-handbook/server-channels)** - Access to <ChannelBadge label="📙moderators" link="https://discord.com/channels/734595073920204940/943466763314663474" /> and other moderator channels
